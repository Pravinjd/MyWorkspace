...
public class Capture_WebElement_ScreenShot {
	...
	public static void main(String[] args) throws IOException {
		...
		//select web element & locate it
		WebElement section =driver.findElement(By.xpath("//div[@id='droppable']"));
		...
		File dest=new File("C:\\Users\\admin\\eclipse-workspace\\Practises\\Screenshots\\WB_dropable.png");
